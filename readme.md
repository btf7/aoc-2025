...
If I spend a lot of time doing something that the standard library has a function for, it's because I'm relatively new to the language and either didn't know it existed or completely forgot about it.

## Build

1.	From whichever day you want to build, create a build folder
	-	```
